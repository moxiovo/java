...
public class Schedule {
    ...
    public Schedule(LocalDate today, boolean morning, LocalTime mstart, LocalTime mend, int mTotalNumber, int mAppointNumbe, boolean afternoon, LocalTime astart, LocalTime aend, int aTotalNumber, int aAppointNumbe) {
        this.today = today;
